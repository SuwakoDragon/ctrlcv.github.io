...
<script setup>
            ...
            if(Array.isArray(coordinates[0][0][0])){
                coordinates.forEach((multiPolygon)=>{
                    multiPolygon.forEach((polygon)=>{
                        ...
                        const material = new THREE.MeshBasicMaterial({ color: '#3AB5AF', transparent: true, opacity: 0.6 });
    ...
    function animate() {
        ...
        if (lastPick) {
          lastPick.object.material[0].color.set('#3AB5AF')
          lastPick.object.material[1].color.set('#7FFFAA')
        }
        lastPick = null
